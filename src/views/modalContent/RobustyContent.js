    ...
    <>
      ...
      <div className="text-center">
        ...
        <div className="my-6 flex justify-center">
          <ReactPlayer width="1050px" height="550px" url='https://www.youtube.com/watch?v=8MAC1lXQ6bE&t=1s' muted={true} playing={true} controls={true} loop={true} />
        </div>
        <p className="text-lg">1/2 – Видео с демонстрационной версией приложения</p>
        <div className="my-6 flex justify-center">
          <ReactPlayer width="1050px" height="550px" url='https://www.youtube.com/watch?v=cOvv4eV8bFQ' muted={true} playing={true} controls={true} loop={true} />
        </div>
